...
__all__ = [
    ...
    'load_pretrained_weights', 'set_bn_to_train', 'set_bn_to_eval'
]
...
def load_checkpoint(fpath):
    ...
    Examples::
        >>> from pkd.utils import load_checkpoint
...
def resume_from_checkpoint(fpath, model, optimizer=None, scheduler=None):
    ...
    Examples::
        >>> from pkd.utils import resume_from_checkpoint
        >>> fpath = 'log/my_model/model.pth.tar-10'
...
def open_all_layers(model):
    ...
    Examples::
        >>> from pkd.utils import open_all_layers
...
def open_specified_layers(model, open_layers):
    ...
    Examples::
        >>> from pkd.utils import open_specified_layers
...
def count_num_param(model):
    ...
    Examples::
        >>> from pkd.utils import count_num_param
...
def load_pretrained_weights(model, weight_path):
    ...
    Examples::
        >>> from pkd.utils import load_pretrained_weights
