...
from pkd.data.sampler import build_train_sampler
from pkd.data.datasets import init_image_dataset, init_video_dataset
from pkd.data.transforms import build_transforms
...
class ImageDataManager(DataManager):
    ...
    Examples::
        ...
        datamanager = pkd.data.ImageDataManager(
...
class VideoDataManager(DataManager):
    ...
    Examples::
        ...
        datamanager = pkd.data.VideoDataManager(
            root='path/to/reid-data',
            sources='mars',
            height=256,
            width=128,
